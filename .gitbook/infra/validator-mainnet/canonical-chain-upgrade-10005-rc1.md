...
Following [proposal #133](https://biyahub.com/proposals/133) This indicates that the upgrade procedure should be performed on block number **9614200**
...
The Biyaliquid Canonical Chain will undergo a scheduled enhancement upgrade on **Monday, April 11th, 2022 (approximately at 14:00 UTC)**.
...
3. Install the [Mainnet-v1.5.0-1649280277](https://github.com/biya-coin/biyaliquid-chain-releases/releases/tag/v1.5.0-1649280277)
...
In the event that the upgrade does not succeed, validators and operators must restore the snapshot and downgrade back to [Biyaliquid Chain 10004-rc1-patch release](https://github.com/biya-coin/biyaliquid-chain-releases/releases/tag/v1.4.0-1645352045) and continue the chain until next upgrade announcement.

### Upgrade Procedure

1.  Verify you are currently running the correct version (`30b3dbf`) of `biyaliquidd`:
...
3.  Download and install the biyaliquid-chain `10005-rc1 release`

    ```bash
    wget https://github.com/biya-coin/biyaliquid-chain-releases/releases/download/v1.5.0-1649280277/linux-amd64.zip
    unzip linux-amd64.zip
    sudo mv biyaliquidd peggo /usr/bin
    ```
4.  Verify you are currently running the correct version (`568ce23`) of `biyaliquidd` after downloading the 10005-rc1 release:
