...
Following [Proposal 550](https://biyahub.com/proposal/550/) This indicates that the upgrade procedure should be performed on block number **129772500**
...
The Biyaliquid Chain will undergo a scheduled enhancement upgrade on **Tuesday, August 19th, 2025, 14:00 UTC**.
...
3. Install the [v1.16.2](https://github.com/biya-coin/biyaliquid-chain-releases/releases/tag/v1.16.2-1755212690) binaries.
...
In the event that the upgrade does not succeed, validators and operators must restore the snapshot and downgrade back to Biyaliquid Chain release [v1.16.1](https://github.com/biya-coin/biyaliquid-chain-releases/releases/tag/v1.16.1-1754161770) and continue this earlier chain until next upgrade announcement.
...
1.  Verify you are currently running the correct version (`v1.16.1`) of `biyaliquidd`:
...
3. Download and install the `biyaliquid-chain` release for `v1.16.2`:

    ```bash
    wget https://github.com/biya-coin/biyaliquid-chain-releases/releases/download/v1.16.2-1755212690/linux-amd64.zip
    unzip linux-amd64.zip
    sudo mv biyaliquidd peggo /usr/bin
    sudo mv libwasmvm.x86_64.so /usr/lib
    ```

4.  Verify you are currently running the correct version (`v1.16.2`) of `biyaliquidd` after downloading the`v1.16.2` release:
