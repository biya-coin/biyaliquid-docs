...
Following [proposal 182](https://biyahub.com/proposals/182/) This indicates that the upgrade procedure should be performed on block number **19761600**
...
The Biyaliquid Canonical Chain will undergo a scheduled enhancement upgrade on **Thursday, November 21st, 2022, 14:00 UTC**.
...
3. Install the [Mainnet-10008-1668679102](https://github.com/biya-coin/biyaliquid-chain-releases/releases/tag/v1.8.0-1668679102)
...
In the event that the upgrade does not succeed, validators and operators must restore the snapshot and downgrade back to [Biyaliquid Chain 10007-rc1 release](https://github.com/biya-coin/biyaliquid-chain-releases/releases/download/v1.7.0-1665417543/linux-amd64.zip) and continue the chain until next upgrade announcement.
...
1.  Verify you are currently running the correct version (`ca447cf8`) of `biyaliquidd`:
...
3.  Download and install the biyaliquid-chain `10008 release`

    ```bash
    wget https://github.com/biya-coin/biyaliquid-chain-releases/releases/download/v1.8.0-1668679102/linux-amd64.zip
    unzip linux-amd64.zip
    sudo mv biyaliquidd peggo /usr/bin
    sudo mv libwasmvm.x86_64.so /usr/lib
    ```
4.  Verify you are currently running the correct version (`64c9081`) of `biyaliquidd` after downloading the 10008 release:
