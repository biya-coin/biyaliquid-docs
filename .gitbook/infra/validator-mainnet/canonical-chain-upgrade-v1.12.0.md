...
Following [proposal 314](https://biyahub.com/proposals/314/) This indicates that the upgrade procedure should be performed on block number **57076000**
...
The Biyaliquid Canonical Chain will undergo a scheduled enhancement upgrade on **Thursday, January 11th, 2024, 14:00 UTC**.
...
3. Install the [v1.12.0-1704530206](https://github.com/biya-coin/biyaliquid-chain-releases/releases/tag/v1.12.0-1704530206)
...
In the event that the upgrade does not succeed, validators and operators must restore the snapshot and downgrade back to [Biyaliquid Chain 10011 release](https://github.com/biya-coin/biyaliquid-chain-releases/releases/tag/v1.11.6-1688984159) and continue the chain until next upgrade announcement.
...
1.  Verify you are currently running the correct version (`69fb0c5`) of `biyaliquidd`:
...
3.  Download and install the biyaliquid-chain `v1.12.0 release`

    ```bash
    wget https://github.com/biya-coin/biyaliquid-chain-releases/releases/download/v1.12.0-1704530206/linux-amd64.zip
    unzip linux-amd64.zip
    sudo mv biyaliquidd peggo /usr/bin
    sudo mv libwasmvm.x86_64.so /usr/lib
    ```
4.  Verify you are currently running the correct version (`b92723b13`) of `biyaliquidd` after downloading the v1.12.0 release:
