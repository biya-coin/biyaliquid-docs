...
Following [proposal #93](https://biyahub.com/proposals/93) This indicates that the upgrade procedure should be performed on block number **6159200**
...
The Biyaliquid Canonical Chain will undergo a scheduled enhancement upgrade on **Thursday, December 30th, 2021 (approximately 14:00 UTC)**.
...
3. Install the [Mainnet-10003-rc1-1640627705](https://github.com/biya-coin/biyaliquid-chain-releases/releases/tag/v1.1.1-1640627705)
...
In the event that the upgrade does not succeed, validators and operators must restore the snapshot and downgrade back to [Biyaliquid Chain 10002-rc2 release](https://github.com/biya-coin/biyaliquid-chain-releases/releases/tag/v1.1.1-1636733798) and continue the chain until next upgrade announcement.

### Upgrade Procedure

1.  Verify you are currently running the correct version (`096cbe5`) of `biyaliquidd`:
...
3.  Download and install the biyaliquid-chain `10003-rc1 release`

    ```bash
    wget https://github.com/biya-coin/biyaliquid-chain-releases/releases/download/v1.1.1-1640627705/linux-amd64.zip
    unzip linux-amd64.zip
    sudo mv biyaliquidd peggo /usr/bin
    ```
4.  Verify you are currently running the correct version (`260e526`) of `biyaliquidd` after downloading the 10003-rc1 release:
