...
Following [proposal #106](https://biyahub.com/proposals/106) This indicates that the upgrade procedure should be performed on block number **7067700**
...
The Biyaliquid Canonical Chain will undergo a scheduled enhancement upgrade on **Tuesday, January 25th, 2022 (approximately at 14:00 UTC)**.
...
3. Install the [Mainnet-10004-rc1-v1.4.0-1642928125](https://github.com/biya-coin/biyaliquid-chain-releases/releases/tag/v1.4.0-1642928125)
...
In the event that the upgrade does not succeed, validators and operators must restore the snapshot and downgrade back to [Biyaliquid Chain 10003-rc1 release](https://github.com/biya-coin/biyaliquid-chain-releases/releases/tag/v1.1.1-1640627705) and continue the chain until next upgrade announcement.

### Upgrade Procedure

1.  Verify you are currently running the correct version (`260e526`) of `biyaliquidd`:
...
3.  Download and install the biyaliquid-chain `10004-rc1 release`

    ```bash
    wget https://github.com/biya-coin/biyaliquid-chain-releases/releases/download/v1.4.0-1642928125/linux-amd64.zip
    unzip linux-amd64.zip
    sudo mv biyaliquidd peggo /usr/bin
    ```
4.  Verify you are currently running the correct version (`94583db`) of `biyaliquidd` after downloading the 10004-rc1 release:
