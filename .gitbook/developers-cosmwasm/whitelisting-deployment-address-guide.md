...
Contract upload on Biyaliquid mainnet requires governance approval. You can read through the guide to do so in the [mainnet-deployment.md](./mainnet-deployment-guide.md "mention") guide.
...
This governance process is time-consuming for validators and the community. Biyaliquid builders additionally face a 4-day wait to roll out features, affecting developer experience and user growth.
...
2. Has the team completed KYC/KYB with the Biyaliquid Foundation?
3. How long has the protocol been live on Biyaliquid mainnet?
...
1. The project has completed Biyaliquid Foundation KYC/KYB and the team members' identities are known to the community. _Exception: Anonymous developers with proven credibility and successful apps in other ecosystems._
