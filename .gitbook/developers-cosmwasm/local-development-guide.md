...
* You can use the [Biyachain Testnet Explorer](https://testnet.prv.scan.biya.io/zh/transactions/smart-contracts/code/) to query your transactions and get more details,
...
* You can use the [Biyachain Testnet Explorer](https://testnet.prv.scan.biya.io/zh/transactions/smart-contracts/code/) to find information about the `codeId` of the uploaded smart contracts OR find your instantiated smart contract
