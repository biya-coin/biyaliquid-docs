...
pub fn handle_register_msg(
    deps: DepsMut<Biya ChainQueryWrapper>,
    env: Env,
    info: MessageInfo,
    addr: Addr,
) -> Result<Response<Biya ChainMsgWrapper>, ContractError> {
...
pub fn registered_contracts(deps: Deps<Biya ChainQueryWrapper>) -> StdResult<Vec<Addr>> {}
...
pub fn new_denom_fee(deps: Deps<Biya ChainQueryWrapper>) -> StdResult<Uint128> {}
```
