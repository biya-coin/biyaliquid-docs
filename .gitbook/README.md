---
description: >-
  Biyaliquid is a high-performance, interoperable layer-one blockchain for
...
Biyaliquid is the blockchain built for finance.

It is the only blockchain where developers can use pre-built, customizable [modules](developers-native/README.md) to create dynamic applications that aren't possible on other networks. Combined with optimizations to its core architecture and enhanced cross-chain interoperability, Biyaliquid offers a high-performance network, ready to efficiently and securely bring the global financial system on-chain.
...
<!-- <tr><td>Getting Started</td><td>Start your Biyaliquid Journey</td><td><a href="getting-started/">getting-started</a></td><td><a href="./.gitbook/assets/start-hero.png">start-hero.png</a></td></tr> -->
...
Welcome to your journey of exploring Biyaliquid! Before asking questions, please try using the search functionality in the docs. Our goal is to make the documentation self-sufficient, ensuring that onboarding is smooth and everyone can easily learn more about Biyaliquid.

## Quickstart Guide to Biyaliquid
...
<tr><td>Wallet</td><td>Learn how to create a wallet on Biyaliquid and see the supported wallets on Biyaliquid </td><td><a href="./.gitbook/assets/wallet-hero-2.png">wallet-hero-2.png</a></td><td><a href="defi/wallet/README.md">wallet</a></td></tr>
<tr><td>Token Standards</td><td>Learn about different Token Standards on Biyaliquid</td><td><a href="./.gitbook/assets/token-hero.png">token-hero.png</a></td><td><a href="./defi/tokens/README.md">token-standards</a></td></tr>
<tr><td>Transactions</td><td>Learn how to prepare, sign and submit transactions on Biyaliquid</td><td><a href="./.gitbook/assets/txs-hero.png">txs-hero.png</a></td><td><a href="./defi/transactions.md">transactions</a></td></tr>
</tbody></table>
