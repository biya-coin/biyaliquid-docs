...
奖励通过两种不同方法分配给[合格市场](/broken/pages/kL1qh68IUtu47dUGRqSL)：
...
有关每个周期 $$TAR$$ 的更多信息，请参阅[奖励池](/broken/pages/tuhOa0mBoyPiBZzIJK3a)页面。
{% endhint %}

对于每个合格市场，做市商 的 $$LS^{0.7}$$ 和 $$Volume$$ 的乘积在所有做市商中聚合。奖励根据所有适用市场的比例聚合乘积分配给每个市场。市场的预分配金额（1%）也会加入。
