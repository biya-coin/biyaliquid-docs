...
Biya Chain 地址可以通过满足以下条件来获得 OLP 资格：
...
有关从单个地址执行多个策略同时保留交易[费用折扣](https://helixapp.com/fee-discounts)的方法，请参阅 [Biya Chain `authz` 模块文档](https://docs.biyachain.network/develop/modules/Core/authz/)。
{% endhint %}
