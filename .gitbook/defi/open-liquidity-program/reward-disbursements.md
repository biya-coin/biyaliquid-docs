...
All rewards are subject to governance approval, and all addresses eligible for more than 500 BIYA per epoch are subject to KYC/KYB verification before their reward disbursement is included in a governance proposal submitted by Biyachain Labs. While any address can permissionlessly join OLP, reward eligibility is dependent on KYC/KYB.
