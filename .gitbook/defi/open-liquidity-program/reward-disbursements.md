...
所有奖励均需治理批准，每个周期符合条件超过 500 BIYA 的所有地址在奖励发放包含在 Biyachain Labs 提交的治理提案之前，都需要进行 KYC/KYB 验证。虽然任何地址都可以无许可加入 OLP，但奖励资格取决于 KYC/KYB。

{% hint style="info" %}
由于所需的治理流程，发放通常在每个周期结束后几天进行。
{% endhint %}

奖励发放可以在 [Biyachain 浏览器](https://prv.scan.biya.io/zh/transactions/)的社区支出池页面上跟踪。
