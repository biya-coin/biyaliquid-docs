...
Rewards for OLP are disbursed in the form of BIYA, Biya Chain's native utility and governance token.
...
{% hint style="info" %}
All rewards are subject to governance approval by the Biya Chain community.
{% endhint %}

More information on OLP rewards can be found on the [OLP Dashboard](https://trading.biyachain.network/program/liquidity) under the [Biya Chain Trading Portal](https://trading.biyachain.network/).
