...
Rewards for OLP are disbursed in the form of BIYA, Biyachain's native utility and governance token.
...
{% hint style="info" %}
All rewards are subject to governance approval by the Biyachain community.
{% endhint %}

More information on OLP rewards can be found on the [OLP Dashboard](https://trading.biyachain.network/program/liquidity) under the [Biyachain Trading Portal](https://trading.biyachain.network/).
