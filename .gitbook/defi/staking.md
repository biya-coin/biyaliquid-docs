...
Biya Chain follows a proof-of-stake mechanism, in which users can stake their BIYA tokens with certain Biya Chain nodes that validate transactions (validators). In return, the user can obtain staking rewards in BIYA.
...
Rewards start accruing the moment you stake BIYA. Monitor your rewards in the staking section of [Biya Chain Hub](https://biyahub.com/stake). Once you have earned a sufficient amount of rewards, you may withdraw them at any time.
