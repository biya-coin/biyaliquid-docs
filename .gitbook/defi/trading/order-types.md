---
description: Read about order types on Biyachain
---

# Order Types

The following list describes the supported order types on Biyachain:

* **BUY (1):** A standard buy order to purchase an asset at either the current market price or a set limit price. Market orders in Biyachain also have a price to stablish a limit to the market price the order will be executed with.
* **SELL (2):** A standard sell order to sell an asset at either the current market price or a set limit price. Market orders in Biyachain also have a price to stablish a limit to the market price the order will be executed with.
