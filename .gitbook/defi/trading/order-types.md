---
description: 了解 Biyachain 上的订单类型
---

# 订单类型

以下列表描述了 Biyachain 上支持的订单类型：

* **BUY (1):** 标准买单，以当前市场价格或设定的限价购买资产。Biyachain 中的市价单也有价格参数，用于限制订单执行时的市场价格。
* **SELL (2):** 标准卖单，以当前市场价格或设定的限价出售资产。Biyachain 中的市价单也有价格参数，用于限制订单执行时的市场价格。
