...
iAssets 是一类新的现实世界资产（RWA）衍生品，以完全链上、可组合和资本高效的形式将传统市场（如股票、大宗商品和外汇）带到 Biya Chain。
...
* iAssets 在 Biya Chain 上继续 24/7 交易，即使标记价格不更新。用户通过像 Helix 这样的前端交易 iAssets 时总是会收到潜在风险的警告，该前端会检查预言机的活跃度。
