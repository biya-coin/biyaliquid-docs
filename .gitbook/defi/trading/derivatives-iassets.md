...
iAssets are a new class of real-world asset (RWA) derivatives that bring traditional markets - such as equities, commodities, and FX - onto Biyachain in a fully on-chain, composable, and capital-efficient form.
...
iAssets do not require pre-funding or wrapping of the underlying asset. Instead, they exist purely as synthetic derivatives, powered by Biyachain’s on-chain perpetual futures engine and decentralized oracle infrastructure. More information on iAssets can be found in [the whitepaper](https://biyachain.com/iAssets_Paper.pdf).

iAssets trade identically to other Biyachain perpetual futures contracts:
...
* Liquidations follow Biyachain’s auction-based mechanism
...
* iAssets continue trading 24/7 on Biyachain, even when the mark price is not updating. Users are always warned of the potential risks when trading iAssets through a frontend like Helix, which checks for oracle liveness.
