...
* 压缩公钥: `{"@type":"/biyachain.crypto.v1beta1.ethsecp256k1.PubKey","key":"ApNNebT58zlZxO2yjHiRTJ7a7ufjIzeq5HhLrbmtg9Y/"}`
...
请参阅 [Swagger API](https://lcd.biyachain.network/swagger/) 参考以获取账户 API 的完整文档。
