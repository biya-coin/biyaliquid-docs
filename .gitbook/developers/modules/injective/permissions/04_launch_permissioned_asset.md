...
Permissioned assets can be launched using [Biyaliquid APIs/SDKs](https://api.biyaliquid.exchange/#permissions) or the Biyaliquid CLI, `biyaliquidd`. See [biyaliquidd](../../../../developers/biyaliquidd/README.md) for more information on using the Biyaliquid CLI.
