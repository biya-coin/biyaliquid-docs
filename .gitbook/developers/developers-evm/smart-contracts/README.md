...
and test, deploy, verify, and interact with them on Biya Chain's Ethereum Virtual Machine (EVM).
...
This guide will walk you through building an EVM Smart Contract on Biya Chain Testnet using [Hardhat](https://hardhat.org/).
...
This guide will walk you through building an EVM Smart Contract on Biya Chain Testnet using [Foundry](https://getfoundry.sh/).
