...
Biyachain Chain validators decided to use the same Ethereum keys for another chain\
...
These values are the average Biyachain Chain block time and Ethereum block time respectively\
