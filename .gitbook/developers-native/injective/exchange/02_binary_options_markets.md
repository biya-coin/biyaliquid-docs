...
Binary options markets can take one of three statuses on Biyaliquid: Active, Expired or Demolished. After the market is created, the market has an `Active` status, which signifies that individuals can begin trading.
