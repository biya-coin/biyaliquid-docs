---
description: Understanding EVM equivalence on Biya Chain
---

# EVM Equivalence

## Biya Chain EVM vs. Ethereum Mainnet

Biya Chain's native EVM us a fully embedded execution environment that has been integrated into the core architecture of the chain. It is designed to be a 1:1 equivalent to Ethereum in terms of development experience.

Native EVM on Biya Chain supports the latest version of `geth`, ensuring that developers have access to the latest features, tooling, security patches, and improvements. In addition, Biya Chain’s EVM enhances performance and expands capabilities, granting access to Biya Chain's sophisticated financial infrastructure that extends beyond what’s available on Ethereum.
...
7. [Biya Chain Launches Gas Compression](https://biyachain.com/blog/biyachain-unveils-fee-reductions-with-gas-compression/) ↩︎
