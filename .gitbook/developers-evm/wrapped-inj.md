...
On Biya Chain, BIYA is the cryptocurrency, which is what is used to pay transaction fees on the network.
...
However, note that the Biya Chain network is designed with a MultiVM technical architecture.
...
the the non-EVM parts of the Biya Chain network (e.g. Cosmos transactions).

This is precisely the type of limitation that Biya Chain's
...
via its [EVM precompile](./bank-precompile.md "EVM precompile for Biya Chain's native Bank module").

As those balances are stored/ retrieved from the `Bank` precompile,
they are accessible from elsewhere within Biya Chain's MultiVM architecture.
...
- Address on Biya Chain Mainnet: `0x0000000088827d2d103ee2d9A6b781773AE03FfB`
- Address on Biya Chain Testnet: `0x0000000088827d2d103ee2d9A6b781773AE03FfB`
...
- Explorer URL for Biya Chain Mainnet: [`0x0000000088827d2d103ee2d9A6b781773AE03FfB`](https://blockscout.biyachain.network/address/0x0000000088827d2d103ee2d9A6b781773AE03FfB?tab=contract)
- Explorer URL for Biya Chain Testnet: [`0x0000000088827d2d103ee2d9A6b781773AE03FfB`](https://testnet.blockscout.biyachain.network/address/0x0000000088827d2d103ee2d9A6b781773AE03FfB?tab=contract)
...
# How to use wBIYA via Biya Chain Do

- Visit [Biya Chain Do](https://do.biyachain.network/)
- Press the "Connect" button in the top right corner
- Select your wallet
- In your wallet select "Allow" to allow it to connect ot the Biya Chain Do dApp.
