...
**拍卖模块(auction module)** 会定期从 **交易模块(exchange module)** 获取由交易手续费累积而成的一篮子代币，并通过 **公开的 English 拍卖** 以 BIYA 竞价的方式将其拍卖给出价最高的竞标者。拍卖的赢家将获得这篮子代币，而本次拍卖中的获胜 BIYA 出价金额将被销毁（burn）。
