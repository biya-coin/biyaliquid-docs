...
要了解更多关于在 Biyachain 上创建代币的信息，请查看[这里](https://docs.injective.network/injective-zhong-wen-wen-dang/guides/launch-a-token)。要阅读更多关于 TokenFactory 标准的信息，请查看[这里](https://docs.injective.network/injective-zhong-wen-wen-dang/kai-fa-zhe/modules/injective/tokenfactory)。
